          ...
          <div className="max-w-md w-full bg-white rounded-lg shadow-lg p-6">
            ...
            <div className="mt-6 flex gap-3">
              ...
              <button
                ...
                className="flex-1 px-4 py-2 bg-gray-200 text-gray-700 font-medium rounded-md hover:bg-gray-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500 transition-colors"
              >
                Go Home
              </button>
            </div>
